    ...
    return <>
        <div className="profile-page flex flex-col items-center justify-center h-screen md:h-auto">
            ...
            <div className="mx-[.8rem] my-[.6rem] social-icon">
                <a href="https://www.facebook.com/chearasmey.yt" rel='noopener' title='Facebook' target="_blank"><i className="bx bxl-facebook"></i></a>
                <a href="https://t.me/chearasmey" target="_blank" rel='noopener' title='Telegram'><i className="bx bxl-telegram"></i></a>
                <a href="https://x.com/chearasmey" target="_blank" rel='noopener' title='Twitter'><i className="bx bxl-twitter"></i></a>
                <a href="https://linkedin.com/in/chearasmey" rel='noopener' title='Linkedin' target="_blank"><i className="bx bxl-linkedin"></i></a>
                <a href="https://www.instagram.com/dr.chearasmey" rel='noopener' title='Instagram' target="_blank"><i className="bx bxl-instagram-alt"></i></a>
            </div>
            ...
            <div className="mt-[1.2rem] flex">
                <Link to="https://drive.google.com/file/d/1XNnIEmga0Pki2GCxqDMZwWNV1mEG72ad/view?usp=sharing" className="btn">View CV</Link>
